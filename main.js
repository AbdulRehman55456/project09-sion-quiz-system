...
const quiz = await inquirer.prompt([
    {
        name: "question_01",
        type: "list",
        message: "Which of the following is a valid way to declare a variable in TypeScript?",
        choices: [
            "let x:number = hello",
            " var x = 10",
            "const x: number",
    ...
    },
    {
        name: "question_03",
        type: "list",
        message: " Which TypeScript feature allows you to create a new type by combining multiple existing types?",
        choices: ["Union Types", "Intersection types", "Generics", "Type Aliases"],
    },
    {
        name: "question_04",
        type: "list",
        message: "Which TypeScript feature ensures that a variable can hold values of only one specified type at a time?",
